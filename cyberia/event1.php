...
/*$(document).ready(function(){
	...
	$(".b").animate({left:'+=470px'});
	$(".b").animate({top:'-=40px'});
	$(".b").animate({left:'-=230px',width:'680px',height:'590px',fontSize:'2em',border-Radius:10px},"slow");
...
<div class="events 1" onclick="myfun(470,0,'1')" ><div class="11" style="margin-bottom:6px;display:block">JEFFEY PAWLAN  (TALK)</div>
<div class="event1">
<br><p style="font-size:36px">TALK BY JEFFEY PAWLAN </p>
	<br><div id="content"><img src="pawlan.jpg" style="height:180px;width:150px;float:left;padding-right:10px">
	<h1 style="padding-left:200px">Coming Soon!!</h1>
<br><br><br><br><br><br><br><br>
  <button class="button-success pure-button" >Register Now</button></div>
</div></div><br><br>
...
<div class="events 4" onclick="myfun(470,120,'4')" ><div class="44" style="margin-bottom:6px;display:block"> HACKATHON</div>
<div class="event1"><br>
<p style="font-size:36px">HACKATHON</p>
	<br><div id="content">
	<h1 style="padding-left:200px">Coming Soon!!</h1>
<br><br><br><br><br><br>
  <button class="button-success pure-button" >Register Now</button></div>
...
<img src="mesh.png" style="width:350px;height:270px;margin-left:150px;"><br>
...
<br><p style="font-size:36px">PAPYRUS</p>
	<br><div id="content">
	Ideas, imagination and intellect serve as the ingredients for innovation, but remain locked in the convolutions of the mind. With the sole purpose of exploiting the dormant ideas, Papyrus, a national level paper presentation contest. Papyrus salutes the spirit & zeal of promising future researchers.
Focusing not only at the personal insight and treatment given to a paper, Papyrus, accentuates on the presentation. Individual research, flawless reasoning and superb exhibition mould the mantra to success.
Papyrus primarily intended to fabricate a discernment process where technical skills, mirrored as invigorating presentations, could be displayed.
<br><br><br><br><br><br>
  <button class="button-success pure-button" >Register Now</button>
